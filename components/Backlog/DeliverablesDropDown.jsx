...
function DeliverablesDropDown({ data }) {
  ...
  return (
    <Menu as="div" className={`relative inline-block text-left`}>
        ...
        >
            <Menu.Items className={`absolute z-50 left-0 mt-2 w-[248px] origin-top-right divide-y divide-gray-100 rounded-md border-[1px] shadow-lg ring-1 ring-black/5 focus:outline-none overflow-auto max-h-[380px] ${theme === 'light' ? "border-[#B4C6E4] text-[#143261] bg-white": "border-[#143261] bg-[#061123] text-[#99C0FF]"}`}>
                <div className="p-2">
